    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-16" data-aos="fade-up">
            ...
            <p class="text-neutral-400 text-lg leading-relaxed max-w-3xl">
                Al utilizar los servicios de Orosolar, usted acepta estos términos y condiciones. Por favor, léalos cuidadosamente antes de utilizar nuestros servicios de energía renovable.
            </p>
        ...
        <div class="max-w-full mx-auto space-y-12">
            ...
            <section data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        Nos reservamos el derecho de modificar estos términos en cualquier momento. Los cambios entrarán en vigor inmediatamente después de su publicación en este sitio web. Su uso continuado de nuestros servicios después de dichos cambios constituye su aceptación de los nuevos términos.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <ul class="list-disc list-inside space-y-2 ml-4">
                        <li>Consultoría y asesoramiento en energía solar</li>
                        <li>Diseño e instalación de sistemas de paneles solares</li>
                        <li>Mantenimiento y reparación de sistemas solares</li>
                        <li>Análisis de viabilidad energética</li>
                        <li>Servicios de monitoreo y gestión energética</li>
                    </ul>
                    <p class="mt-4">
            ...
            <section data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p class="mt-4">
                        Nos reservamos el derecho de suspender o terminar su acceso al sitio web si viola estos términos.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        Usted no puede reproducir, distribuir, modificar, crear obras derivadas, mostrar públicamente, realizar públicamente, republicar, descargar, almacenar o transmitir ningún material de nuestro sitio web sin nuestro consentimiento previo por escrito.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        Todos los servicios están sujetos a la firma de un contrato escrito que detallará los términos específicos, precios, plazos y condiciones del proyecto. El contrato formal prevalecerá sobre cualquier comunicación previa.
                    </p>
                    <p>
                        Los proyectos están sujetos a disponibilidad de materiales, condiciones climáticas y aprobaciones regulatorias necesarias.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <ul class="list-disc list-inside space-y-2 ml-4">
                        <li>Se puede requerir un depósito inicial antes del inicio del trabajo</li>
                        <li>Los pagos se realizarán según el cronograma acordado en el contrato</li>
                        <li>Los pagos vencidos pueden resultar en la suspensión de los servicios</li>
                        <li>Todos los precios están en la moneda especificada y pueden estar sujetos a impuestos aplicables</li>
                    </ul>
                    <p class="mt-4">
                        Los reembolsos están sujetos a los términos específicos del contrato y a nuestra política de cancelación.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="800">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        En caso de cancelación por parte del cliente después del inicio del trabajo, se pueden aplicar cargos por trabajo realizado y materiales adquiridos. Las cancelaciones por parte de Orosolar debido a circunstancias fuera de nuestro control no darán lugar a responsabilidad adicional.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="900">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        El cliente debe cumplir con todas las leyes, regulaciones y códigos de construcción aplicables. Orosolar se compromete a cumplir con los estándares de seguridad y códigos eléctricos vigentes.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="1000">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <ul class="list-disc list-inside space-y-2 ml-4">
                        <li>Su uso o mal uso de nuestros servicios</li>
                        <li>Su violación de estos términos</li>
                        <li>Su violación de cualquier derecho de un tercero</li>
                        <li>Cualquier contenido que usted proporcione</li>
                    </ul>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="1200">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        Estos términos se rigen por las leyes de [País/Jurisdicción]. Cualquier acción legal debe iniciarse en los tribunales competentes de [Ciudad, País].
                    </p>
                </div>
            </section>
        ...
        <!-- Contact CTA Section -->
        <section class="max-w-7xl mx-auto mt-20" data-aos="fade-up">
                ...
                <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 px-16 py-20">
                    <div>
                        ...
                        <p class="text-neutral-400 mt-4 max-w-xl">
                            Si necesitas aclaraciones sobre nuestros términos de servicio o deseas discutir un proyecto, nuestro equipo está disponible para asistirte.
                        </p>
                    </div>
