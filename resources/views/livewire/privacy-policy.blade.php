    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-16" data-aos="fade-up">
            ...
            <p class="text-neutral-400 text-lg leading-relaxed max-w-3xl">
                En Orosolar, nos comprometemos a proteger su privacidad y garantizar la seguridad de sus datos personales. Esta política explica cómo recopilamos, utilizamos y protegemos su información.
            </p>
        ...
        <div class="max-w-full mx-auto space-y-12">
            ...
            <section data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <ul class="list-disc list-inside space-y-2 ml-4">
                        <li>Solicita una cotización o consulta sobre nuestros servicios de energía solar</li>
                        <li>Se registra en nuestro sitio web o newsletter</li>
                        <li>Se comunica con nosotros por correo electrónico, teléfono o formulario de contacto</li>
                        <li>Participa en encuestas, promociones o eventos</li>
                    </ul>
                    <p class="mt-4">
                        La información que recopilamos puede incluir: nombre, dirección de correo electrónico, número de teléfono, dirección física, información sobre su propiedad, consumo energético, y cualquier otra información que elija compartir con nosotros.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <ul class="list-disc list-inside space-y-2 ml-4">
                        <li>Proporcionar, mantener y mejorar nuestros servicios de energía renovable</li>
                        <li>Procesar y responder a sus consultas y solicitudes</li>
                        <li>Enviar información sobre nuestros productos, servicios y promociones</li>
            ...
            <section data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        Utilizamos tecnologías de encriptación, firewalls y controles de acceso para proteger sus datos. Nuestro personal está capacitado en el manejo seguro de información personal.
                    </p>
                </div>
            </section>
            ...
            <section data-aos="fade-up" data-aos-delay="500">
                ...
                <div class="space-y-4 text-neutral-300 leading-relaxed">
                    ...
                    <p>
                        Los tipos de cookies que utilizamos incluyen: cookies esenciales (necesarias para el funcionamiento del sitio), cookies de rendimiento (para analizar el uso del sitio) y cookies de funcionalidad (para recordar sus preferencias).
                    </p>
                </div>
            </section>
                ...
                <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 px-16 py-20">
                    <div>
                        ...
                        <p class="text-neutral-400 mt-4 max-w-xl">
                            Si tienes alguna duda sobre cómo manejamos tu información personal o deseas ejercer tus derechos, nuestro equipo está disponible para asistirte.
                        </p>
                    </div>
