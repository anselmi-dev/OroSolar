    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="max-w-4xl mx-auto space-y-4">
            @foreach($this->faqs as $index => $faq)
                <div
                    class="bg-neutral-900 rounded-xl overflow-hidden border border-neutral-800 transition-all duration-300 hover:border-yellow-400/50"
                    x-data="{ open: @entangle('openIndex') == {{ $index }} }"
                >
                    <!-- Question Header -->
                    <button
                    ...
                    >
                        ...
                        <div class="flex-shrink-0">
                            <svg
                                class="w-6 h-6 text-yellow-400 transition-transform duration-300"
...
<script>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('collapse', () => ({
            init() {
                this.$watch('$el.style.display', (value) => {
                    if (value === 'none') {
