    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="max-w-4xl mx-auto space-y-4">
            @foreach($this->faqs as $index => $faq)
                <div
                    class="bg-neutral-900 rounded-xl overflow-hidden border border-neutral-800 transition-all duration-300 hover:border-app-400/50"
                ...
                >
                    ...
                    >
                        ...
                        <div class="flex-shrink-0">
                            <svg
                                class="w-6 h-6 text-app-400 transition-transform duration-300"
