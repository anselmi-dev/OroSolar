<div class="min-h-screen bg-black text-white py-20">
    <div class="max-w-7xl mx-auto" data-aos="fade-up">
        <h1 class="text-5xl font-extrabold mb-8">Projects</h1>
        <p class="text-neutral-400 text-lg leading-relaxed max-w-3xl">
            Explore our latest renewable energy projects and case studies.
        </p>
    </div>

    <section class="max-w-7xl mx-auto relative py-20 grid md:grid-cols-3 gap-14">
        ...
        <div data-aos="fade-up" data-aos-delay="100">
            ...
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
                Sed vel lacus bibendum, mollis lacus vel, condimentum augue. In ornare, lacus eu maximus blandit, ex
                dolor consectetur quam, ac viverra libero dui et elit.
            </p>
        ...
        <div data-aos="fade-up" data-aos-delay="200">
            ...
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
                Fusce et nulla feugiat nisl sollicitudin blandit. Integer gravida auctor ante, ut fringilla nisi
                porta ac. Nunc id tellus mauris. Sed hendrerit, nisi eget bibendum ultricies.
            </p>
        ...
        <div data-aos="fade-up" data-aos-delay="400">
            ...
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
                Sed vel lacus bibendum, mollis lacus vel, condimentum augue. In ornare, lacus eu maximus blandit, ac
                viverra libero dui et elit.
            </p>
