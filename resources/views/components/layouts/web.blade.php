            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex items-start gap-2">
                        ...
                        Carmen Covarrubia 32 OF 510, Santiago RM
                    </li>
                    <li class="flex items-center gap-2">
                        ...
                        <a href="tel:+56939450537" class="hover:text-app-400 transition">+56939450537</a>
                    </li>
                    <li class="flex items-center gap-2">
                        <span class="text-app-400 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <a href="mailto:info@orosolar.com" class="hover:text-app-400 transition">info@orosolar.com</a>
                    </li>
                    <li class="flex items-center gap-2">
                        <span class="text-app-400 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
