    ...
    <footer class="bg-gradient-to-t from-black to-neutral-800 text-gray-300 pt-16 pb-6">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li class="flex items-start gap-2">
                        <span class="text-yellow-400 flex-shrink-0 mt-0.5">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="{{ route('faqs') }}" class="hover:text-yellow-500  text-yellow-400">FAQs</a></li>
                    <li><a href="{{ route('privacy-policy') }}" class="hover:text-yellow-500  text-yellow-400">Privacy Policy</a></li>
                    <li><a href="{{ route('terms-of-service') }}" class="hover:text-yellow-500  text-yellow-400">Terms & Conditions</a></li>
                </ul>
            </div>
